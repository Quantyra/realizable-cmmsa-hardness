...
Slack variables, AND products, concentration, weight rounding, secret sharing, and the star compilation are established techniques. The new argument is their quantitative composition with the modified repetition, actual advice posterior, conditional rank/zoom-out control, and descending threshold ladder. We retain the source local-decoder statement below for comparison. The enlarged-ambient application used here is the robust 8\(S\) lemma proved below; the outer hardness, star transport and maximal-pair counting machinery remain cited inputs. The STOC 2026 full text of MZ was not accessible in the assessment; claims about its numerical details are confined to the accessible arXiv v1, also linked by a coauthor.
...
The following contracts identify the established source results and their parameter ranges. Precise public versions and bibliographic links are in the bibliography. Contract 3 records the scoped source decoder for comparison; our changed-ambient argument uses the separately proved robust 8\(S\) application. The other contracts remain explicit mathematical imports. None is claimed to be locally Lean-formalized.
...
$\genfrac{[}{]}{0pt}{}{j}{k}_2\,2^{k(j-k)}$. The Gaussian product formula gives
$\genfrac{[}{]}{0pt}{}{j}{k}_2\le4\,2^{k(j-k)}$: its denominator product exceeds
...
For a $t$-space,
$\mathbf1_{t>0}=\sum_{k=1}^t\genfrac{[}{]}{0pt}{}{t}{k}_2\alpha_k$.
This follows by putting $z=-1$ in
$\prod_{l=0}^{t-1}(1+2^lz)
=\sum_k\genfrac{[}{]}{0pt}{}{t}{k}_2\,2^{k(k-1)/2}z^k$.
The product identity follows inductively from
$\genfrac{[}{]}{0pt}{}{t}{k}_2=\genfrac{[}{]}{0pt}{}{t-1}{k}_2+2^{t-k}\genfrac{[}{]}{0pt}{}{t-1}{k-1}_2$,
...
\[
 \genfrac{[}{]}{0pt}{}{a}{i}_2\genfrac{[}{]}{0pt}{}{b}{j}_2\,2^{k(a-i)}2^{k(b-j)}.   \tag{A9}
\]
...
$\sum_{a+b\le j}\genfrac{[}{]}{0pt}{}{j}{a}_2\genfrac{[}{]}{0pt}{}{j-a}{b}_2$ hybrid pairs:

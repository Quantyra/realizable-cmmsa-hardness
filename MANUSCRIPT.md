...
Take M to be the least power of two that satisfies
...
L these are in the promised ranges. The sampling success is at least 5/6
when using ln 12 in the least-power-of-two list size. Corollary 2 follows
